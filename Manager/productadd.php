    ...
    <div class="container  " id="crudApp">
        <div class=" home_content ">
            ...
            <div class="col-12" align="center">
                ...
                <div class="col-md-4">
                    <h1 class="mt-3" Style="border: 1px solid #000; border-radius: 30px; background-color:#DDDDDD;">Name
                        Product</h1>
                </div>
                ...
                <div class="col-12 mb-3" align="right">
                    <input type="button" class="btn btn-success btn-xs m-3  " data-bs-toggle="modal"
                        data-bs-target="#myModal" @click="openModal" value="Add Product">
                </div>
                ...
                <div class="table-responsive-lg ">
                    <table class="table table-bordered  table-striped table-sm ">
                        ...
                        <tr v-for="(row,index) in filteredRows " :key="row.productcode">
                            <td>{{index+1}}</td>
                    ...
                    edit" data-bs-toggle="modal" @click="fetchData(row.productcode)"
                                    data-bs-target="#myModal">Edit</button>
                                <button type="button" name="delete" class="btn btn-danger btn-sm
                        delete" data-bs-toggle="modal" @click="deleteData(row.productcode)"
                            ...
                            <div class="modal-body row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" v-model="product_code" class="form-control form-control-sm"
                                        ...
                                        <label for="Product Code" style="font-size:12px; font-weight:bold; ">ไม่เกิน 8 ตัวอักษร</label>
                                </div>
                                <br>
                                <div class="col-md-6">
                                    <label for="Product Name">Product Name</label><br>
                                    <input type="text" v-model="product_name" class="form-control form-control-sm"
                                        style="border-radius: 30px;" placeholder="Product Name..." maxlength="15">

                                        <label for="Product Name" style="font-size:12px; font-weight:bold; ">ไม่เกิน 15 ตัวอักษร</label>
                                </div>
                                <br>
