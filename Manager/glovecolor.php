...
<body style="background-color:#ffff; overflow:auto; ">
            ...
            <div class="col-12" align="center">
                ...
                <div class="col-12 mb-3" align="right">
                    <input type="button" class="btn btn-success btn-xs  " data-bs-toggle="modal"
                        data-bs-target="#myModal" @click="openModal" value="Add Color">
                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body row g-3">
                                ...
                                <!-- <div class="col-md-6">
                                        ...
                                        <input type="text" v-model="run_code" class="form-control form-control-sm"
                                            style="border-radius: 30px;" placeholder="Code..." maxlength="15">
                                    </div>
                                    <br> -->
                                <div class="col-md-6">
                                    <label for="Glove Color">Glove Color</label><br>
                                    <input type="text" v-model="glove_color" class="form-control form-control-sm"
    ...
    <script src="../js/addcolor.js"></script>
