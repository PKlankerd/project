...
<body style="background-color:#ffff; overflow:auto; ">
            ...
            <div class="col-12" align="center">
                ...
                <div class="col-12 mb-3" align="right">
                    <input type="button" class="btn btn-success btn-xs   " data-bs-toggle="modal"
                        data-bs-target="#myModal" @click="openModal" value="Add Shell">
                </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body row g-3">
                                ...
                                <div class="col-md-6">
                                    <label for="Shell Name">Shell Name</label><br>
                                    <input type="text" v-model="shell_name" class="form-control form-control-sm"
    ...
    <script src="../js/addshell.js"></script>
