...
<body style="background-color:#ffff; overflow:auto; ">
    ...
    <div class="container  " id="crudApp">
        <div class=" home_content ">
            ...
            <div class="col-12" align="center">
                ...
                <div class="col-md-4">
                    <h1 class="mt-3" Style="border: 1px solid #000; border-radius: 30px; background-color:#DDDDDD;">StatusAfterProcess</h1>
                </div>
                ...
                <div class="table-responsive-lg ">
                    ...
                    edit" data-bs-toggle="modal" @click="fetchData(row.id)"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body row g-3">
                                ...
                                <div class="col-md-6">
                                    <label for="Status After Process">Status After Process</label><br>
                                    <input type="text" v-model="status_after" class="form-control form-control-sm"
                                        style="border-radius: 30px;" placeholder="Product Name..." >
    ...
    <script src="../js/addstatusafterprocess.js"></script>
