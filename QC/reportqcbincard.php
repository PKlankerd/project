<?php session_start(); 
include_once("../connect/connectionqcbincard.php");
                        ...
                        <table id="table" class="table table-striped table-sm " style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row ['finishedShift']?></td>
                                    <td><?php echo $row ['Operator']?></td>
                                    <td><?php echo $row ['afterprocess']?></td>
