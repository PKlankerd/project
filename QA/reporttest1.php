<?php session_start(); 
include_once("../connect/connectiontest1.php");
...
<head>
    ...
    <title>Statisticaltest1 ANSELL</title>
    ...
    <div class="container " id="crudApp">
        <div class=" home_content ">
            <div class="col-12 " align="center">
                ...
                <div class="col-md-4">
                    <h1 class="mt-3" Style="border: 1px solid #000; border-radius: 30px; background-color:#DDDDDD;">Statistical-test1 Report</h1>
                </div>
                <div class="card " style="background-color: #fff;">
                    <div class="card-body col-md-12 mx-auto ">
                        ...
                        <table id="table" class="table table-striped table-sm" style="width:100%">
                            ...
                            <tbody>
                                <?php foreach($statistical1st as $row):?>
                                <tr>
                                    <td><?php echo $row ['Binno']?></td>
                                    <td><?php echo $row ['Productcode']?></td>
                                    <td><?php echo $row ['Productionlot']?></td>
                                    <td><?php echo $row ['Date1st']?></td>
                                    <td><?php echo $row ['Shift1st']?></td>
                                    <td><?php echo $row ['CriticalPcs1st']?></td>
                                    <td><?php echo $row ['CriticalDefect1st']?></td>
                                    <td><?php echo $row ['MajorPcs1st']?></td>
                                    <td><?php echo $row ['MajorDefect1st']?></td>
                                    <td><?php echo $row ['MinorPcs1st']?></td>
                                    <td><?php echo $row ['MinorDefect1st']?></td>
                                    <td><?php echo $row ['operator1st']?></td>
