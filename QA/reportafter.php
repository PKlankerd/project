<?php session_start(); 
include_once("../connect/connectionafter.php"); 
...
<meta charset="UTF-8">
    ...
    <title>Statistical-after ANSELL</title>
...
<body style="background-color:#ffff; overflow:auto; ">
   ...
   <div class="container " id="crudApp">
        ...
        <div class="col-12 "  align="center" >
            ...
            <div class="col-md-4">
                    <h1 class="mt-3" Style="border: 1px solid #000; border-radius: 30px; background-color:#DDDDDD;">Statistical-after Report</h1>
                </div>
                <div class="card " style="background-color: #fff;">
                    <div class="card-body col-md-12 mx-auto ">
                        ...
                        <table id="table" class="table table-striped table-sm" style="width:100%">
                            ...
                            <tbody>
                                <?php foreach($statisticalafter as $row):?>
                                <tr>
                                    <td><?php echo $row ['Binno']?></td>
                                    <td><?php echo $row ['Productcode']?></td>
                                    <td><?php echo $row ['Productionlot']?></td>
                                    <td><?php echo $row ['DateAfter']?></td>
                                    <td><?php echo $row ['ShiftAfter']?></td>
                                    <td><?php echo $row ['CriticalPcsAfter']?></td>
                                    <td><?php echo $row ['CriticalDefectAfter']?></td>
                                    <td><?php echo $row ['MajorPcsAfter']?></td>
                                    <td><?php echo $row ['MajorDefectAfter']?></td>
                                    <td><?php echo $row ['MinorPcsAfter']?></td>
                                    <td><?php echo $row ['MinorDefectAfter']?></td>
                                    <td><?php echo $row ['statusAfter']?></td>
                                    <td><?php echo $row ['operatorAfter']?></td>
